...
#    parser.add("--gan_noise_size", default=0, type=int)
    ...
    # for diffusion model
    parser.add('--diffusion_steps', default=1000, type=int)
    parser.add('--noise_schedule', default= 'cosine', type=str)
    parser.add('--sigma_small', default= True, type=bool)
    parser.add('--lambda_vel', default=0, type=int)
    parser.add('--lambda_rcxyz', default=0, type=int)
    parser.add('--lambda_fc', default=0, type=int)
    parser.add('--latent_dim', default=512, type=int)
    parser.add('--layers', default=8, type=int)
    parser.add('--cond_mask_prob', default=0.1, type=float)
    parser.add('--arch', default= 'trans_enc', type=str)
